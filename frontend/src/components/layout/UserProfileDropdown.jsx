  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-2.5 rounded-xl border border-slate-200 bg-white py-1.5 pl-1.5 pr-3 shadow-sm transition-all hover:border-slate-300 hover:shadow-md"
      >
        ...
        <svg className="ml-0.5 h-4 w-4 text-slate-400" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
      ...
      <OverlayPanel
        ref={overlayRef}
        className="w-72 !rounded-2xl !border-slate-200 !p-0 !shadow-xl !shadow-slate-200/50"
        pt={{
      ...
      >
        ...
        <div className="p-2">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl border border-rose-200 py-2.5 text-sm font-semibold text-rose-600 transition-colors hover:bg-rose-50"
          >
